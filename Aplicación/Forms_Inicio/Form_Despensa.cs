...
namespace Forms_Inicio
{
    public partial class Form_Despensa : Form
    {
        ...
        private void btn_Queso_Click(object sender, EventArgs e)
        {
            Form_Quesos verQuesos = new Form_Quesos();
            verQuesos.Show();
            this.Hide();
        }
        private void btn_Leche_Click(object sender, EventArgs e)
        {
            Form_Lacteos verLacteos = new Form_Lacteos();
            verLacteos.Show();
            this.Hide();
        }
    }
